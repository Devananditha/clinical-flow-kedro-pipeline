...
## 6. Power BI Executive Data Mart Schema

The analytical mart at `data/04_feature/powerbi_executive_capacity_report.csv` is structured for direct integration into enterprise semantic models and hospital executive dashboards:
...
## 8. Data Governance & Regulatory Notice
